...
#Missing enterprise check: config synchronization / HA split-brain signals#
Add HA health checks for config sync and pfsync status

#Missing enterprise check: gateway reachability vs service reachability (DNS/NTP upstream)#
...
#Missing enterprise check: firmware/update posture and reboot-required state#
...
#Missing enterprise check: configuration backup freshness#
